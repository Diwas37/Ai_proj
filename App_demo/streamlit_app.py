    ...
    with st.sidebar:
        with st.form("my_form"):
            ...
            negative_prompt = st.text_area(":orange[**Negative prompt 🙅🏽‍♂️**]",
                                           ...
                                           height=150)
            image_controlnet = st.file_uploader("Upload img2img (optional)", type=["jpg", "jpeg", "png"], key="img2img_uploader")
        ...
        return option_gen, submitted, width, height, num_outputs, prompt, negative_prompt, image_controlnet, image_inpainting


def main_page(option_gen: str, submitted: bool, width: int, height: int, num_outputs: int,
              prompt: str, negative_prompt: str, image_controlnet, image_inpainting) -> None:
